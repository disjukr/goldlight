...
authors a scene with TSX, including mesh/material/camera declarations, lowers that tree into
`SceneIr`, then renders the result through the browser forward pipeline.
