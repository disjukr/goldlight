...
`@goldlight` should model material alpha behavior as first-class Scene IR policy instead of
inferring render intent from whether a material happens to sample a texture.
