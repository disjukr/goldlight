...
- role-oriented utilities publish through dedicated packages: `@disjukr/goldlight/math`,
  `@disjukr/goldlight/geometry`, `@disjukr/goldlight/spatial`, `@disjukr/goldlight/procedural`, and
  `@disjukr/goldlight/raytrace`
