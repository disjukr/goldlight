...
> => {
  ...
  recordDrawPath(recorder, createKitePath([370, 156], 186, 134), {
    style: 'fill',
  ...
  recordDrawPath(recorder, createRectPath2D(createRect(84, 304, 170, 152)), {
    style: 'fill',
    color: [0.19, 0.54, 0.79, 0.94],
  });
  saveDrawingRecorder(recorder);
  translateDrawingRecorder(recorder, 58, 326);
  recordDrawPath(recorder, createTrianglePath([0, 0], [88, 0], [0, 118]), {
    style: 'fill',
    color: [0.78, 0.46, 0.82, 0.72],
  });
  restoreDrawingRecorder(recorder);
  recordDrawPath(recorder, createKitePath([528, 382], 120, 142), {
    style: 'fill',
