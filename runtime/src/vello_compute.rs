...
pub fn stroke_from_parts(
    width: f32,
    miter_limit: f32,
    cap: crate::render::PathStrokeCap2D,
    join: crate::render::PathStrokeJoin2D,
) -> Stroke {
    let cap = match cap {
        crate::render::PathStrokeCap2D::Butt => Cap::Butt,
        crate::render::PathStrokeCap2D::Square => Cap::Square,
        crate::render::PathStrokeCap2D::Round => Cap::Round,
    };
    let join = match join {
        crate::render::PathStrokeJoin2D::Miter => Join::Miter,
        crate::render::PathStrokeJoin2D::Bevel => Join::Bevel,
        crate::render::PathStrokeJoin2D::Round => Join::Round,
    };
    Stroke {
        width: width as f64,
        join,
